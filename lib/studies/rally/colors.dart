...
class RallyColors {
  ...
  static const List<Color> layer1Colors = <Color>[
    Color(0xFFFFDC78),
    Color(0xFFFF6951),
    Color(0xFFFFD7D0),
    Color(0xFFFFAC12),
  ...
  static const List<Color> layer2Colors = <Color>[
    Color(0xFFB2F2FF),
    Color(0xFFB15DFF),
    Color(0xFF72DEFF),
    Color(0xFF0082FB),
  ...
  /// Convenience method to get a single bill color with position i.
  static Color layer1Color(int i) {
    return cycledColor(layer1Colors, i);
  }
  ...
  /// Convenience method to get a single budget color with position i.
  static Color layer2Color(int i) {
    return cycledColor(layer2Colors, i);
  }
